<template>
  <div class="navbar">
    <div class="statusBox">
      ...
      <span v-if="status===1"
            class="businessBtn">运行中</span>
      <span v-else
            class="businessBtn closing">维护中</span>
    </div>
    ...
    <div :key="restKey"
      ...
      <div class="rightStatus">
        ...
        <span class="navicon operatingState" @click="handleStatus"><i />小程序状态</span>
      </div>
    ...
    <el-dialog title="营业状态设置"
      ...
      <el-radio-group v-model="setStatus">
        <el-radio :label="1">
          运行中
          <span>当前小程序处于正常状态，自动接收任何订单，可点击进入小程序维护状态。</span>
        </el-radio>
        <el-radio :label="0">
          维护中
          <span>当前小程序处于维护状态，仅接受正常运行时的订单，可点手动恢复正常运行状态。</span>
        </el-radio>
      </el-radio-group>
      <span slot="footer"
            class="dialog-footer">
